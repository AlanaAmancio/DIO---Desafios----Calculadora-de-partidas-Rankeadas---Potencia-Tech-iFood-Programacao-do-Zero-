    ...
    let resultado = calcularPartidas(123, 10)
    ...
    switch (calcularPartidas = ferro || bronze || prata || ouro || diamante || lendario || imortal) {
       case(calcularPartidas = ferro) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível ferro.`)
            break;
        
       case (calcularPartidas = bronze) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível bronze.`)
            break;
        
        case (calcularPartidas = prata) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível prata.`)
            break;

        case (calcularPartidas = ouro) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível ouro.`)
            break;

        case (calcularPartidas = diamante) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível diamante.`)
            break;

        case(calcularPartidas = lendario) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível lendário.`)
            break;

        case(calcularPartidas = imortal) :
            console.log(`O heroi tem de saldo de ${resultado} e está no nível imortal.`)
            break;
